...
namespace DmdataSharp
{
	...
	/// </summary>
	public class DmdataDistributorV2Socket : IDisposable
	{
		/// <summary>
		/// WebSocketへの接続が完了した
		/// </summary>
		...
		/// 親となるAPIクライアント
		/// </summary>
		public DmdataDistributorV2ApiClient ApiClient { get; }
		/// <summary>
		...
		public DmdataDistributorV2Socket(DmdataDistributorV2ApiClient apiClient)
		{
			ApiClient = apiClient;
